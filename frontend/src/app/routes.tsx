...
import { LapLich } from "./pages/schedule/LapLich";
import { GhiLog } from "./pages/logs/GhiLog";
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "schedule", element: <LapLich /> },
          { path: "logs", element: <GhiLog /> },
